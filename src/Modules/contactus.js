...
function Contactus()
{
    return(
        ...
        <section className="leftsection">
          <b><h1 className="heading1">Contact us </h1><img className="icon1" src={icon1} alt="pic1.png"/></b> 
          <p className="text">
          ...
          <p className="text"><img className="callicon" src={callicon} alt="abc"/>&ensp;&ensp;(208) 555-0112</p><br/>

         <h1>Visit us</h1><br/>
         <img className="locationicon" src={locationicon} alt="abc"/>
         <p className="adress">
            Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut<br/>
            fugit, sed quia consequuntur magni dolores eos qui.</p> <br/>
         
         <h1>Follow us</h1><br/>
        <img className="fbicon" src={fbicon} alt="abc"/> <p className="fbid">zerozerooffical</p><br/>
        <img className="instaicon" src={instaicon} alt="abc"/><p className="instaid">@zerozerooffical</p>
